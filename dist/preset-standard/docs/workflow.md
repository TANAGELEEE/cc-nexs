...
[Day 1]
人:  /cc-nexs:init "需求描述"
机:  先向 docs 远端 base fast-forward push `doc/01.feature/` 最小占号
     编号立即对未使用 cc-nexs 的其他开发者可见
机:  再创建多仓 feature worktree，展开完整 templates，填写 requirements.md
人:  /cc-nexs:run 01
...
[Day 2]
人:  人工 review 最终报告 → 代码仓先 merge
机:  docs 第二阶段补齐真实 commit / 测试 / 发布结果 → docs merge → finalize cleanup
