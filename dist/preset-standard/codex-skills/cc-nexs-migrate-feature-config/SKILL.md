...
description: /cc-nexs:migrate-feature-config 的 Codex 镜像 skill。 显式调用 $cc-nexs-migrate-feature-config 时使用。 Safely migrate an existing Lean/Hotfix config.json to automatic risk-based model routing without removing explicit overrides.
---
