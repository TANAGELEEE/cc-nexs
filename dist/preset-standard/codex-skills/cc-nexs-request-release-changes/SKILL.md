...
description: /cc-nexs:request-release-changes 的 Codex 镜像 skill。 显式调用 $cc-nexs-request-release-changes 时使用。 Record Gateway B feedback and route evidence-only, implementation, or scope changes safely.
---
