...
description: /cc-nexs:release-base 的 Codex 镜像 skill。 显式调用 $cc-nexs-release-base 时使用。 Integrate exact approved Lean/Hotfix candidates into configured base branches and clean worktrees after proof.
---
