...
description: /cc-nexs:evaluator 的 Codex 镜像 skill。 显式调用 $cc-nexs-evaluator 时使用。 Evaluator 契约验收入口。新流程默认 final，仅在完整需求发布并通过最终 QA 后全量验收；sprint 仅供 legacy per_sprint。
---
