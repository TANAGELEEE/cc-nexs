...
description: /cc-nexs:approve-plan 的 Codex 镜像 skill。 显式调用 $cc-nexs-approve-plan 时使用。 Approve the Lean requirements and plan scope, binding the gate to their hashes.
---
