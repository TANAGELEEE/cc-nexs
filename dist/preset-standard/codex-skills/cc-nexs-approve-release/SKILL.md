...
description: /cc-nexs:approve-release 的 Codex 镜像 skill。 显式调用 $cc-nexs-approve-release 时使用。 Approve the exact Lean or Hotfix candidate verified in test before base-branch integration.
---
