...
Read and follow `../../commands/dev.md` as the single source of truth for this command. Treat the user's original message after `/cc-nexs-minimal:dev` as the command arguments.
