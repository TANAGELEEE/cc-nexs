---
name: cc-nexs-init
description: /cc-nexs:init 的 Codex 镜像 skill。 当用户输入 "/cc-nexs:init"、"/cc-nexs:init ..."、"$cc-nexs-init" 或要求执行 cc-nexs init 流程时触发。 Initialize a new feature directory by copying preset templates and creating progress.md. Defaults to creating a git worktree under .worktrees/<id>-<slug>/ for parallel feature development.
---
